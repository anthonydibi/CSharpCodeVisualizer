...
namespace ThreeSharp.Behaviours
{
    public class VisualizationGenerator : MonoBehaviour
    {
        ...
        public GameObject classNodePrefab;
        public GameObject namespaceNodePrefab;
        public Material lineMaterial;
        private GameObject visualizationTransformRoot;
        ...
        {
            GameObject namespaceNodeObject = InstantiateAndLabelNode(projectNode.Key, startCoordinate, Quaternion.identity, namespaceNodePrefab);
            ...
            for (int i = 0; i < projectNode.Children.Count; i++)
            {
                ...
                else if (child is ClassNode)
                {
                    ...
                    GameObject classNodeObject = InstantiateAndLabelNode(child.Key, nodePosition, Quaternion.identity, classNodePrefab);
        ...
        private GameObject InstantiateAndLabelNode(string text, Vector3 pos, Quaternion quaternion, GameObject prefab)
        {
            GameObject nodeObject = Instantiate(prefab, pos, quaternion);
